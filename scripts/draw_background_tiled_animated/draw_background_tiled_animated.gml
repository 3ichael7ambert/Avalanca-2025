...
/// @returns 
function draw_background_tiled_ext_animated(argument0, arg1, argument1, argument2, argument3, argument4, argument5, argument6) {

	draw_sprite_tiled_ext(argument0, arg1, argument1, argument2, argument3, argument4, argument5, argument6);
