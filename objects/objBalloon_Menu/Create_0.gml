...
sprite_array_string = setup_height_vector(,15,[0,4],[1,1],[c_ltgray, c_white],,spr_pole);
sprite_array_balloon = setup_height_vector(,15,[0,4],[1,1],[c_ltgray, c_white],,spr_pole);
sprite_array_reflection = setup_height_vector(,10,[2,4],[1,1],[c_ltgray, c_white],,spr_flag);
