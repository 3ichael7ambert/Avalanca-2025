...
draw_sprite_pos(sprSalomon_Pole,0,lp_x,lp_y,lp_x+(50*scale),lp_y,lp_x+(50*scale)+lengthdir_x(o_menuMain.shadowSize,o_menuMain.sunDirection),lp_y+(50*scale)+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),lp_x+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),lp_y+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),1);
draw_sprite_pos(sprSalomon_Pole,0,rp_x,rp_y,rp_x+(50*scale),rp_y,rp_x+(50*scale)+lengthdir_x(o_menuMain.shadowSize,o_menuMain.sunDirection),rp_y+(50*scale)+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),rp_x+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),rp_y+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),1);
draw_sprite_pos(sprSalomon_Flag,0,lp_x+ (50*scale),lp_y,rp_x,rp_y,rp_x+(50*scale)+lengthdir_x(o_menuMain.shadowSize,o_menuMain.sunDirection),rp_y+(50*scale)+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),lp_x+ (50*scale)+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),lp_y+lengthdir_y(o_menuMain.shadowSize,o_menuMain.sunDirection),1);
