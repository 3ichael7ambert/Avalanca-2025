...
if !position_meeting(self.x,self.y+sprite_height,obj_FenceBorder_menu)and y<room_height+500 then {instance_create(x,y+sprite_height-10,obj_FenceBorder_menu);}
